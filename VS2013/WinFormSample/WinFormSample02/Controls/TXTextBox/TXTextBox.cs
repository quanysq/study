...
namespace WinFormSample02.Controls
{
  ...
  public partial class TXTextBox : UserControl
  {
    ...
    /// 边框颜色
    /// </summary>
    private Color _BorderColor = Color.Red; //TODO //SkinManager.CurrentSkin.BorderColor;

    /// <summary>
    /// 控件激活时的高亮边框色
    /// </summary>
    private Color _HeightLightBolorColor = Color.Blue; //TODO //SkinManager.CurrentSkin.HeightLightControlColor.First;
    ...
    private void DrawBorder(Graphics g)
    {
      ...
      if (this._ControlState == EnumControlState.HeightLight)
      {
        ...
        GDIHelper.DrawPathBorder(g, roundRect, Color.Red);

        //TODO
        //GDIHelper.DrawPathOuterBorder(g, roundRect, SkinManager.CurrentSkin.HeightLightControlColor.First);
        GDIHelper.DrawPathOuterBorder(g, roundRect, Color.Blue);
      }
    }
