...
namespace WinFormSample02.Controls
{
  ...
  public partial class TXButton : Button
  {
      ...
      switch (this._ControlState)
      {
        case EnumControlState.Default:
          if (this.FlatStyle != FlatStyle.Flat)
          {
            ...
            GDIHelper.FillRectangle(g, roundRect, Color.GreenYellow);
    ...
    private void DrawContent(Graphics g)
    {
      ...
      Color forceColor = this.Enabled ? this.ForeColor : Color.Gray;
