...
namespace Console002
{
  ...
  public class C6
  {
    private static ScanResult ScanCore()
    {
      ...
      scanResult.CpuLoad = GetCpuLoad();
      scanResult.MemoryAvailable = GetMemoryAvailable();
      scanResult.Drives = GetLogicalDrives();
      return scanResult;
    }
    ...
    private static List<DiskInfo> GetLogicalDrives()
    {
  ...
  public class DiskInfo 
  {
    ...
    public DiskInfo(string diskName, long diskSize, long freeSpace)
    {
      DiskName = diskName;
      DiskSize = DiskSize;
      FreeSpace = freeSpace;
  ...
  public class ProcessInfo
  {
    ...
    public ProcessInfo(int processID, string processName, double totalMilliseconds, long workingSet64, string fileName)
    {
      ProcessID = processID;
