...
namespace Console037
{
  class Program
  {
    ...
    public static void SetSecurity(string folderpath, string account)
    {
    ...
    public static void SetSecurity(string folderpath, WellKnownSidType wellknownsidtype)
    {
    ...
    public static void GetSecurityRules(string folderpath)
    {
